...
module.exports = {
    getAllLists: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, list_1.default.find()];
                case 1:
                    lists = _a.sent();
    ...
    createList: function (_a, res) {
        var body = _a.body;
        return __awaiter(void 0, void 0, void 0, function () {
            var newList, insertedList, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        newList = new list_1.default(body);
                        return [4 /*yield*/, newList.save()];
                    case 1:
                        insertedList = _b.sent();
    ...
    deleteList: function (_a, res) {
        var id = _a.body.id;
        return __awaiter(void 0, void 0, void 0, function () {
            var deletedList, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, list_1.default.findByIdAndDelete(id)];
                    case 1:
                        deletedList = _b.sent();
